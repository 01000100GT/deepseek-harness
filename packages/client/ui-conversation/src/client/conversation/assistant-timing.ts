// Shared assistant step-timing fold: target Definitions and Trajectory
...
import type { AssistantTiming } from '../contract/records.ts'

// The first-token predicate lives beside the StreamChunk type in dsh-llm;
// re-exported here for consumers sharing the Conversation timing fold.
