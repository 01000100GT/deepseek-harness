/**
 * Cross-domain sessions face consumed by the workspace domain instead of the
 * sessions implementation. The sessions domain satisfies it structurally —
 * SessionRuntime is assignable, checked
