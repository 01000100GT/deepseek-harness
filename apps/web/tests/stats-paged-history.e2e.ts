...
const SNAPSHOT_DIR = fileURLToPath(new URL('./goldens/stats-paged-history', import.meta.url))
const UI_EXPECTED = fileURLToPath(new URL('./goldens/stats-paged-history/ui.expected.md', import.meta.url))
