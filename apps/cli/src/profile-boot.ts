 ...
 * per-composition derived shipped agent-preset root), mount the tree over the
 * profile's empty root config, keep the profile patch layer live, and wire
 * fail-loud plus bounded shutdown.
 *
