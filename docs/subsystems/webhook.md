...
The [GitHub review example](../../examples/web-github-review/README.md) mounts this route on an isolated second WebServer so exposing webhook ingress does not expose the browser API.
